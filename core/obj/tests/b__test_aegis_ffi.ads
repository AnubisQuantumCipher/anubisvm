...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_aegis_ffi" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#126d7c9c#;
   pragma Export (C, u00001, "test_aegis_ffiB");
   ...
   u00107 : constant Version_32 := 16#ad1da994#;
   pragma Export (C, u00107, "aegis_ffiB");
   u00108 : constant Version_32 := 16#bf8993fa#;
   pragma Export (C, u00108, "aegis_ffiS");
   u00109 : constant Version_32 := 16#1f5fce7b#;
   pragma Export (C, u00109, "anubis_sha3B");
   u00110 : constant Version_32 := 16#06c20106#;
   pragma Export (C, u00110, "anubis_sha3S");
   ...
   u00115 : constant Version_32 := 16#68d297b3#;
   pragma Export (C, u00115, "anubis_keccakB");
   u00116 : constant Version_32 := 16#88a5c868#;
   pragma Export (C, u00116, "anubis_keccakS");
   u00117 : constant Version_32 := 16#dea2a956#;
   pragma Export (C, u00117, "anubis_typesS");
   u00118 : constant Version_32 := 16#3c9c2ae7#;
   pragma Export (C, u00118, "interfaces__c__stringsB");
   u00119 : constant Version_32 := 16#fecad76a#;
   ...
   u00122 : constant Version_32 := 16#8f2423cb#;
