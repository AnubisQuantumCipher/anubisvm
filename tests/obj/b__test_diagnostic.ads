...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_diagnostic" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#55831d5e#;
   pragma Export (C, u00001, "test_diagnosticB");
   ...
   u00128 : constant Version_32 := 16#8f2423cb#;
