...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_kpke_debug" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#fd382fc3#;
   pragma Export (C, u00001, "test_kpke_debugB");
   ...
   u00107 : constant Version_32 := 16#19c7b4b2#;
   pragma Export (C, u00107, "anubis_configS");
   u00108 : constant Version_32 := 16#5ca17633#;
   pragma Export (C, u00108, "anubis_fieldB");
   u00109 : constant Version_32 := 16#44178e5a#;
   pragma Export (C, u00109, "anubis_fieldS");
   u00110 : constant Version_32 := 16#e259c480#;
   pragma Export (C, u00110, "system__assertionsB");
   u00111 : constant Version_32 := 16#567524cf#;
   pragma Export (C, u00111, "system__assertionsS");
   u00112 : constant Version_32 := 16#8b2c6428#;
   pragma Export (C, u00112, "ada__assertionsB");
   u00113 : constant Version_32 := 16#cc3ec2fd#;
   pragma Export (C, u00113, "ada__assertionsS");
   u00114 : constant Version_32 := 16#3175d113#;
   pragma Export (C, u00114, "anubis_mlkem_compressB");
   u00115 : constant Version_32 := 16#68bed3d7#;
   pragma Export (C, u00115, "anubis_mlkem_compressS");
   u00116 : constant Version_32 := 16#4763c32a#;
   pragma Export (C, u00116, "anubis_mlkem_typesS");
   u00117 : constant Version_32 := 16#dea2a956#;
   pragma Export (C, u00117, "anubis_typesS");
   u00118 : constant Version_32 := 16#310667cc#;
   pragma Export (C, u00118, "anubis_mlkem_encodingB");
   u00119 : constant Version_32 := 16#ddd03e9c#;
   pragma Export (C, u00119, "anubis_mlkem_encodingS");
   u00120 : constant Version_32 := 16#df54d322#;
   pragma Export (C, u00120, "anubis_mlkem_polyB");
   u00121 : constant Version_32 := 16#a4cdd192#;
   pragma Export (C, u00121, "anubis_mlkem_polyS");
   u00122 : constant Version_32 := 16#7c55654e#;
   pragma Export (C, u00122, "anubis_nttB");
   u00123 : constant Version_32 := 16#d34de1b7#;
   pragma Export (C, u00123, "anubis_nttS");
   u00124 : constant Version_32 := 16#ce168d29#;
   pragma Export (C, u00124, "anubis_mlkem_sampleB");
   u00125 : constant Version_32 := 16#32f9574c#;
   pragma Export (C, u00125, "anubis_mlkem_sampleS");
   u00126 : constant Version_32 := 16#88f42651#;
   pragma Export (C, u00126, "anubis_cbdB");
   u00127 : constant Version_32 := 16#027471d7#;
   pragma Export (C, u00127, "anubis_cbdS");
   u00128 : constant Version_32 := 16#836bf0a8#;
   pragma Export (C, u00128, "anubis_sha3B");
   u00129 : constant Version_32 := 16#95c7bdbf#;
   pragma Export (C, u00129, "anubis_sha3S");
   u00130 : constant Version_32 := 16#68d297b3#;
   pragma Export (C, u00130, "anubis_keccakB");
   u00131 : constant Version_32 := 16#88a5c868#;
   pragma Export (C, u00131, "anubis_keccakS");
   u00132 : constant Version_32 := 16#19ff6eea#;
   pragma Export (C, u00132, "system__img_unsS");
   u00133 : constant Version_32 := 16#8f2423cb#;
   pragma Export (C, u00133, "system__memoryB");
   u00134 : constant Version_32 := 16#68e2c74e#;
