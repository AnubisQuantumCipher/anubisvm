...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_mldsa_minimal" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#b52f6ebc#;
   pragma Export (C, u00001, "test_mldsa_minimalB");
