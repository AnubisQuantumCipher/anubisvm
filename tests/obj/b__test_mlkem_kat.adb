pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__test_mlkem_kat.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__test_mlkem_kat.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_test_mlkem_kat");
