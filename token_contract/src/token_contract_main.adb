--  token_contract Test Runner
with Ada.Text_IO; use Ada.Text_IO;
with Interfaces;
with token_contract; use token_contract;

procedure token_contract_Main is
   State : Contract_State := Empty_State;
begin
   Put_Line ("KHEPRI Contract Test: token_contract");
   Put_Line ("===========================");
   New_Line;
